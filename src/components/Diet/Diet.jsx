...
import dietImg from '../../img/bg1.jpg'
  ...
  return (
    <div className='bg-sky-50 pb-10'>
      <div className='w-full md:h-96 h-80 flex flex-col items-center justify-center' style={{ backgroundImage: `url(${dietImg})` }}>
        <h1 className='text-red-400 text-3xl'>What to put on your plate?</h1>
        <div className='text-center pt-5 px-5 max-w-2xl text-red-400'>
      ...
      <h1 className='text-center text-3xl text-red-600 pt-10'>Here are some tips for healthy Diet</h1>
      ...
      {/* Cards */}
      <h1 className='text-center text-3xl text-red-600 pt-20'>Example Menu for you</h1>
          ...
          <div className="flex flex-wrap">
            <div className="p-4 md:w-1/2 ">
              <div
                ...
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-red-700 mb-3">Breakfast</h1>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                ...
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-red-700 mb-3">Lunch</h1>
                  <ul className='list-disc'>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                className="h-full shadow-sm shadow-green-100 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white">
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-red-700 mb-3">Dinner</h1>
                  <ul className='list-disc'>
            ...
            <div className="p-4 md:w-1/2 ">
              <div
                className="h-full shadow-sm shadow-green-100 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white">
                <div className="p-8">
                  <h1 className="title-font text-2xl font-medium text-center text-red-700 mb-3">Snack</h1>
                  <ul className='list-disc'>
      ...
      {/* Remember */}
      <h1 className='text-center text-3xl text-red-600 pt-20 pb-5'>Remember Sunita...</h1>
